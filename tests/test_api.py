"""Tests for Schedule Sensor api."""
import asyncio

import aiohttp
from custom_components.schedule_sensor.api import (
    ScheduleSensorApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = ScheduleSensorApiClient("test", "test", async_get_clientsession(hass))
